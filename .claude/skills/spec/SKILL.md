...
6. Tell the user to run `/clear`, switch `/model` back to Sonnet, then say "build from SPEC.md, walking skeleton first" — so the build starts with clean context on the cheaper model.
