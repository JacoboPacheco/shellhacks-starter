...
1. Read CLAUDE.md first, especially the sponsor/company challenges list and the stack. If PHASE is still 0, run `/check` first: red, or "browser check skipped" → stop and finish PLAYBOOK Phase 0. Sponsor list empty → ask for it in round one.
